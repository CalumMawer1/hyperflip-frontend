      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold tracking-wider flex items-center">
            <DiamondTrophySVG className="mr-3 text-5xl font-primary" />
            <span className="text-gradient-primary">LEADERBOARD</span>
          </h1>
          <Link href="/" className="font-primary bg-primary-light hover:bg-primary-medium px-4 py-2 rounded-md border border-primary-dark transition-all duration-300 flex items-center">
